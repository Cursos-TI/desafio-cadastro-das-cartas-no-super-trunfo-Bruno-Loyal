...
int main(){
    ...
    // Densidade Populacional:
    float densidade_populacional_2 = (float)populacao_2 / area_km_2;
    
    // PIB per Capita:
    float pib_percapita_2 = pib_2 / (float)populacao_2;
    ...
    printf("[1] - Iniciar Trunfo de cartas\n");
    printf("[2] - Regras do Duelo\n");
    printf("[3] - SAIR\n");
    ...
    {
    case 1:
        printf("[1] - Mostrar atributos e valores da carta 1\n");
        printf("[2] - Mostrar atributos e valores da carta 2\n");
        printf("[3] - Duelar todos os atributos carta 1 x carta 2\n");
        printf("[4] - Duelar 1 atributo por vez.\n");
        printf("[5] - SAIR\n");
        scanf("%d", &opcao);
        ...
        case 3:
            ...
            break;
        case 4:
            printf("Escolha um dos atributos para Duelar:\n");
            printf("[1] - Atributo População\n");
            printf("[2] - Atributo Área Km²\n");
    ...
    case 2:
        ...
        printf("Selecione uma opção para duelar e ganhe 1 ponto por vitória\n");
        printf("Caso escolha duelar todos atributos, será analisado os valores das duas cartas,\n");
        printf("e retornará quantos pontos cada carta ganhou, a que tiver mais pontos vence.\n");
        printf("Vence a carta que tiver o maior valor exceto em atributo densidade populacional vence o menor valor.\n");
        break;
    case 3:
        printf("Saindo...\n");
        break;
